    ...
    @Bean
       protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                .csrf().disable()
                .authorizeRequests()
                .requestMatchers( "/create,","/login","/authenticate").permitAll()
                .and()
                .authorizeRequests()
                ...
                .authenticationEntryPoint((request, response, authException) -> {
                    System.out.println("Authenticatn entry point called. Rejecting access");
                    response.sendError(HttpServletResponse.SC_FORBIDDEN, "Access Deied");
                })
                .and()
                .build();
